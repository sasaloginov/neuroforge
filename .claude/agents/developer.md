...
### DRY / KISS / SOLID
- **DRY** — не дублируй логику. Повторяющийся код выноси в общие функции/модули
- **KISS** — выбирай простейшее работающее решение. Абстракция оправдана только когда упрощает понимание или поддержку
- **SOLID:**
  - Single Responsibility — один модуль = одна причина для изменений
  - Open/Closed — расширяй через новые модули, не правь существующие без нужды
  - Liskov Substitution — реализации портов взаимозаменяемы
  - Interface Segregation — порты узкие и специализированные
  - Dependency Inversion — зависимости от абстракций (портов), не от реализаций
