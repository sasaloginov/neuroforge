...
## Процесс работы
1. Прочитай `context.md` — карта затрагиваемого кода от analyst'а. Используй для навигации, не перечитывай файлы, если информация уже там
2. Прочитай `PROJECT_MAP.md` — общая карта модулей проекта. Используй для понимания зависимостей
3. Прочитай задачу (TASK.md) и спецификацию (design/spec.md)
4. Прочитай CLAUDE.md проекта — конвенции и архитектура
4. Реализуй код, следуя DDD-структуре
